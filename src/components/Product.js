    ...
    <div className="product">
      <div className="product__details">
        ...
        <div className="product__overview">
          ...
          <p>
            {item.description}A modifier is a special type of Solidity function
            that is used to modify the behavior of other functions. For example,
            developers can use a modifier to check that a certain condition is
            met before allowing the function to execute.
          </p>
        </div>
